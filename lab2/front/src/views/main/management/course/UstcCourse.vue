  ...
  <el-container v-if="isShow">
    ...
    <el-container>
      ...
      <el-main>
        ...
        <Ustc-dialog @dialogVisibleClick="dialogVisibleClick" @editDialog="editDialog" @noeditDialog="noeditDialog" @searchList="searchList" @teacherSearch="teacherSearch" title="课程信息" :cnoVisible="true" :form="form" :course="course" :teacher="teacher" :dialogFormVisible="dialogFormVisible" />
        <Ustc-dialog @dialogVisibleClick="dialogAddVisibleClick" @editDialog="addCourse" @searchList="searchList" @teacherSearch="teacherSearch" title="新增课程" :cnoVisible="false" :dialogFormVisible="dialogAddCourseVisible" :course="course" :teacher="teacher"/>
      </el-main>
    </el-container>
...
import UstcDialog from 'components/common/UstcDialog'
