  ...
  <el-container v-if="isShow">
    ...
    <el-container>
      ...
      <el-main>
        ...
        <UstcDialogStudent @dialogVisibleClick="dialogAddVisibleClick" @editDialog="addStudent"  title="新增学生" :snoVisible="false" :dialogFormVisible="dialogAddStudentVisible" />
      </el-main>
    </el-container>
...
import UstcDialogStudent from 'components/common/UstcDialogStudent'
...
import { addStudentInfo } from 'network/management/addStudentInfo'
export default {
  name: 'UstcStudentInfo',
  components: {
    UstcHeader,
    UstcAside,
    UstcFooter,
