...
export default{
    ...
    data(){
        ...
        return {
            ...
            rules: {
                oldPass:[
                    {validator: validateOldPas, trigger: ['blur', 'change']}
                ],
                pass: [
    ...
    methods:{
        btnClick(){
            ...
            if(this.ruleForm.oldPass === '' || this.ruleForm.pass === '' || this.ruleForm.checkPass === '' || pass.test(this.ruleForm.pass) === false || this.ruleForm.pass !== this.ruleForm.checkPass){
                return
            }
            const username = localStorage.getItem('Username')
            const oldPass = this.ruleForm.oldPass
            const password = this.ruleForm.pass
            const data = JSON.stringify({oldPass, password})
            this.isLoading = true
            console.log(data)
